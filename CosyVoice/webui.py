...
def add_cosyvoice3_system_prompt(text):
...
def generate_audio(tts_text, mode_checkbox_group, sft_dropdown, prompt_text, prompt_wav_upload, prompt_wav_record, instruct_text,
    ...
    if mode_checkbox_group == '预训练音色':
        ...
        set_all_random_seed(seed)
        if isinstance(cosyvoice, CosyVoice3):
            prompt_text = add_cosyvoice3_system_prompt(prompt_text)
        ...
        set_all_random_seed(seed)
        if isinstance(cosyvoice, CosyVoice3):
            tts_text = add_cosyvoice3_system_prompt(tts_text)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_dir',
                        type=str,
                        default=  'pretrained_models/Fun-CosyVoice3-0.5B', #'pretrained_models/CosyVoice2-0.5B',
