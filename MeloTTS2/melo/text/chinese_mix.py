...
from .mix_symbols import language_tone_start_map
...
model_id = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "bert_model", "multilingual")
...
def get_bert_feature(text, word2ph, device):
    from . import multilingual_bert
    return multilingual_bert.get_bert_feature(text, word2ph, device=device)
